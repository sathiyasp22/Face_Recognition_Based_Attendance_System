...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'www.mzcet.in' ")
...
def TrainImages():
    ...
    now = datetime.now()
    mess.showinfo("Successful", "you are present on   "+now.strftime("%d/%m/%Y %H:%M:%S"))
...
head2 = tk.Label(frame2, text="                   For Attendance Registrations                       ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                               CREDITS                                    ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Attendance" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#00aeff" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)
load= Image.open("mz/f.jpg")
render = ImageTk.PhotoImage(load)
img = tk.Label(image=render)
img.place(x=250, y=300)
# lbl3 = tk.Label(frame1, image='mz/f.jpg',width=20  ,fg="black"  ,bg="#00aeff"  ,height=1 ,font=('times', 17, ' bold '))
# lbl3.place(x=100, y=115)
# root = tk.Tk()
# img = IMAGETEXT.PhotoImage(Image.open('mz/f.jpg'))
...
trainImg = tk.Button(frame2, text="Save Attendance", command=psw ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="WELCOME TO MZCET", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
